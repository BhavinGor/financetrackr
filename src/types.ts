...
// New extension interfaces for transaction-based system
...
// Extended transaction with metadata for display
export interface TransactionWithMetadata extends Transaction {
  fuelData?: FuelTransaction & { vehicleName?: string };
